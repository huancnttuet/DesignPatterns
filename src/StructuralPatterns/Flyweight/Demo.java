...
import StructuralPatterns.Flyweight.forest.ForestNotFlyWeight;
...
public class Demo {
    ...
    public static void main(String[] args) {
        ...
        // ForestNotFlyWeight forestNotFlyWeight = new ForestNotFlyWeight();
        for (int i = 0; i < Math.floor(TREES_TO_DRAW / TREE_TYPES); i++) {
            ...
            // forestNotFlyWeight.plantTree(random(0, CANVAS_SIZE), random(0, CANVAS_SIZE),
        ...
        // forestNotFlyWeight.setSize(CANVAS_SIZE, CANVAS_SIZE);
        // forestNotFlyWeight.setVisible(true);
